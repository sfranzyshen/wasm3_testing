...
# Convert to WAT
bin/wasm3 wasm/wasm2wat.wasm --generate-names app_delay.wasm -o app_delay.wat
...
# Convert to WAT
bin/wasm3 wasm/wasm2wat.wasm --generate-names app_nodelay.wasm -o app_nodelay.wat
