...
WASM_IMPORT("arduino", "pinMode")         void pinMode        (uint8_t pin, uint8_t mode);
WASM_IMPORT("arduino", "digitalWrite")    void digitalWrite   (uint8_t pin, uint8_t value);

// This is a convenience function
WASM_IMPORT("arduino", "getPinLED")       uint8_t getPinLED   (void);
